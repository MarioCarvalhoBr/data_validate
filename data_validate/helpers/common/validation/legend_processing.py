...
class LegendProcessing:
    ...
    def validate_legend_columns_dtypes_numeric(self, original_dataframe: pd.DataFrame, code_value: Any, code_col: str, label_col: str, min_col: str, max_col: str, order_col: str) -> List[str]:
    ...
    def validate_min_max_values(self, dataframe: pd.DataFrame, code: Any,  min_col: str, max_col: str, label_col: str) -> List[str]:
