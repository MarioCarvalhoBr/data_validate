...
class SpLegendValidator(ValidatorModelABC):
    ...
    def validate_relation_indicators_in_legend(self) -> Tuple[List[str], List[str]]:
        ...
        required_columns = {self.sp_name_description: [SpDescription.RequiredColumn.COLUMN_CODE.name, SpDescription.RequiredColumn.COLUMN_LEVEL.name, SpDescription.DynamicColumn.COLUMN_LEGEND.name]}
