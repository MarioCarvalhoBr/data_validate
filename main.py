...
if __name__ == "__main__":
    ...
    # Run orchestrator
    orc.run(input_folder=args.input_folder, no_spellchecker=args.no_spellchecker, lang_dict=args.lang_dict, no_warning_titles_length=args.no_warning_titles_length, debug=args.debug)
