...
class MetadataInfo(ConstantBase):
    ...
    def _make_url(
        ...
        """Make the URL people should start at for this version of src.__init__.py."""
        return "https://src.readthedocs.io/en/" + MetadataInfo._make_version(major, minor, micro, release_level, serial, dev)
