...
def test_errors_verify_combination_sp_description_values_scenario_temporal_reference_data_errors_05():
    ...
    assert errors[0] == "valores.xlsx: A coluna '5000-2030-O' é desnecessária."
    assert errors[1] == "valores.xlsx: A coluna '5000-2050-O' é desnecessária."
    assert errors[2] == "valores.xlsx: A coluna '5000-2030-P' é desnecessária."
    assert errors[3] == "valores.xlsx: A coluna '5000-2050-P' é desnecessária."
    assert errors[4] == "valores.xlsx: A coluna '5003-2030-O' é desnecessária."
    assert errors[5] == "valores.xlsx: A coluna '5003-2050-O' é desnecessária."
    assert errors[6] == "valores.xlsx: A coluna '5003-2030-P' é desnecessária."
    assert errors[7] == "valores.xlsx: A coluna '5003-2050-P' é desnecessária."
