...
def test_count_errors_verify_unavailable_values_data_errors_07():
    ...
    assert warnings[0] == "valores.xlsx, linha 3: Existem 203 valores com mais de 2 casas decimais, serão consideradas apenas as 2 primeiras casas decimais."
...
def test_count_errors_verify_ids_sp_description_values_data_errors_04():
    ...
    assert errors[0] == "valores.xlsx: Colunas inválidas: ['5000.954-2015', '5001,9483-2015']."
