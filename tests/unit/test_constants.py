...
df_sp_scenario_data_ground_truth_02, errors_read_file = read_excel_file(os.path.join(path_input_data_ground_truth_02, SP_SCENARIO_COLUMNS.NAME_SP))
df_sp_temporal_reference_data_ground_truth_02, errors_read_file = read_excel_file(os.path.join(path_input_data_ground_truth_02, SP_TEMPORAL_REFERENCE_COLUMNS.NAME_SP))
df_sp_description_data_ground_truth_02, errors_read_file = read_excel_file(os.path.join(path_input_data_ground_truth_02, SP_DESCRIPTION_COLUMNS.NAME_SP))
df_sp_composition_data_ground_truth_02, errors_read_file = read_excel_file(os.path.join(path_input_data_ground_truth_02, SP_COMPOSITION_COLUMNS.NAME_SP))
df_sp_values_data_ground_truth_02, errors_read_file = read_excel_file(os.path.join(path_input_data_ground_truth_02, SP_VALUES_COLUMNS.NAME_SP))
df_sp_proportionalities_data_ground_truth_02, errors_read_file = read_excel_file(os.path.join(path_input_data_ground_truth_02, SP_PROPORTIONALITIES_COLUMNS.NAME_SP))
...
df_sp_values_errors_06, errors_read_file = read_excel_file(os.path.join(path_input_data_errors_06, SP_VALUES_COLUMNS.NAME_SP))
