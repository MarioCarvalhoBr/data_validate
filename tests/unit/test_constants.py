...
path_input_data_ground_truth_02 = "input_data/data_ground_truth_02"
...
df_sp_scenario_data_ground_truth_01 = read_excel_file(os.path.join(path_input_data_ground_truth_01, SP_SCENARIO_COLUMNS.NAME_SP))
df_sp_temporal_reference_data_ground_truth_01 = read_excel_file(os.path.join(path_input_data_ground_truth_01, SP_TEMPORAL_REFERENCE_COLUMNS.NAME_SP))
df_sp_description_data_ground_truth_01 = read_excel_file(os.path.join(path_input_data_ground_truth_01, SP_DESCRIPTION_COLUMNS.NAME_SP))
df_sp_composition_data_ground_truth_01 = read_excel_file(os.path.join(path_input_data_ground_truth_01, SP_COMPOSITION_COLUMNS.NAME_SP))
df_sp_values_data_ground_truth_01 = read_excel_file(os.path.join(path_input_data_ground_truth_01, SP_VALUES_COLUMNS.NAME_SP))
df_sp_proportionalities_data_ground_truth_01 = read_excel_file(os.path.join(path_input_data_ground_truth_01, SP_PROPORTIONALITIES_COLUMNS.NAME_SP))

# 1.2 DATA FRAMES - GROUND TRUTH: path_input_data_ground_truth_02
df_sp_scenario_data_ground_truth_02 = read_excel_file(os.path.join(path_input_data_ground_truth_02, SP_SCENARIO_COLUMNS.NAME_SP))
df_sp_temporal_reference_data_ground_truth_02 = read_excel_file(os.path.join(path_input_data_ground_truth_02, SP_TEMPORAL_REFERENCE_COLUMNS.NAME_SP))
df_sp_description_data_ground_truth_02 = read_excel_file(os.path.join(path_input_data_ground_truth_02, SP_DESCRIPTION_COLUMNS.NAME_SP))
df_sp_composition_data_ground_truth_02 = read_excel_file(os.path.join(path_input_data_ground_truth_02, SP_COMPOSITION_COLUMNS.NAME_SP))
df_sp_values_data_ground_truth_02 = read_excel_file(os.path.join(path_input_data_ground_truth_02, SP_VALUES_COLUMNS.NAME_SP))
df_sp_proportionalities_data_ground_truth_02 = read_excel_file(os.path.join(path_input_data_ground_truth_02, SP_PROPORTIONALITIES_COLUMNS.NAME_SP))
...
df_sp_scenario_errors_05 = read_excel_file(os.path.join(path_input_data_errors_05, SP_SCENARIO_COLUMNS.NAME_SP))
df_sp_temporal_reference_errors_05 = read_excel_file(os.path.join(path_input_data_errors_05, SP_TEMPORAL_REFERENCE_COLUMNS.NAME_SP))
df_sp_description_errors_05 = read_excel_file(os.path.join(path_input_data_errors_05, SP_DESCRIPTION_COLUMNS.NAME_SP))
df_sp_composition_errors_05 = read_excel_file(os.path.join(path_input_data_errors_05, SP_COMPOSITION_COLUMNS.NAME_SP))
df_sp_values_errors_05 = read_excel_file(os.path.join(path_input_data_errors_05, SP_VALUES_COLUMNS.NAME_SP))
df_sp_proportionalities_errors_05 = read_excel_file(os.path.join(path_input_data_errors_05, SP_PROPORTIONALITIES_COLUMNS.NAME_SP))
