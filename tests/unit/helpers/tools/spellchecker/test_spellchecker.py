...
class TestSpellChecker:
    ...
    def test_initialization(self, mocker) -> None:
        ...
        with mocker.patch('data_validate.helpers.tools.spellchecker.spellchecker.DictionaryManager', return_value=mock_dictionary_manager), \
    ...
    def test_check_spelling_text_success(self, mocker) -> None:
        ...
        df = pd.DataFrame({
            'texto_sem_erro': ['texto correto', 'outro texto'],
            'texto_com_erros': ['texto com erros', 'mais erros']
        })
        ...
        with mocker.patch('data_validate.helpers.tools.spellchecker.spellchecker.DictionaryManager', return_value=mock_dictionary_manager), \
            ...
            errors, warnings = spellchecker.check_spelling_text(
                df, "test.xlsx", ["texto_sem_erro", "texto_com_erros"]
            )
    ...
    def test_check_spelling_text_dictionary_initialization_fails(self, mocker) -> None:
        ...
        df = pd.DataFrame({
            'texto_sem_erro': ['texto correto'],
            'texto_com_erros': ['texto com erros']
        })
    ...
    def test_check_spelling_text_with_single_column(self, mocker) -> None:
        ...
        df = pd.DataFrame({
            'texto': ['texto correto', 'texto com erros']
        })
...
class TestSpellCheckerEdgeCases:
    ...
    def test_check_spelling_text_with_very_large_dataframe(self, mocker) -> None:
        ...
        large_data = {
            'texto': [f'texto {i}' for i in range(10000)]
        }
    ...
    def test_check_spelling_text_with_many_columns(self, mocker) -> None:
        ...
        with mocker.patch('data_validate.helpers.tools.spellchecker.spellchecker.DictionaryManager', return_value=mock_dictionary_manager), \
            ...
            errors, warnings = spellchecker.check_spelling_text(
                df, "many_columns_test.xlsx", column_names
            )
    ...
    def test_check_spelling_text_with_unicode_text(self, mocker) -> None:
        ...
        df = pd.DataFrame({
            'texto_unicode': ['café', 'naïve', 'résumé', 'café', 'naïve']
        })
        ...
        with mocker.patch('data_validate.helpers.tools.spellchecker.spellchecker.DictionaryManager', return_value=mock_dictionary_manager), \
            ...
            errors, warnings = spellchecker.check_spelling_text(
                df, "unicode_test.xlsx", ["texto_unicode"]
            )
    ...
    def test_check_spelling_text_with_special_characters(self, mocker) -> None:
        ...
        df = pd.DataFrame({
            'texto_especial': ['texto@email.com', 'www.site.com', 'texto (com parênteses)', 'texto "com aspas"']
        })
        ...
        with mocker.patch('data_validate.helpers.tools.spellchecker.spellchecker.DictionaryManager', return_value=mock_dictionary_manager), \
            ...
            errors, warnings = spellchecker.check_spelling_text(
                df, "special_chars_test.xlsx", ["texto_especial"]
            )
...
class TestSpellCheckerIntegration:
    ...
    def test_complete_workflow_success(self, mocker) -> None:
        ...
        df = pd.DataFrame({
            'texto_sem_erro': ['texto correto', 'outro texto correto'],
            'texto_com_erros': ['texto com erros', 'mais erros aqui']
        })
        ...
        with mocker.patch('data_validate.helpers.tools.spellchecker.spellchecker.DictionaryManager', return_value=mock_dictionary_manager), \
            ...
            errors, warnings = spellchecker.check_spelling_text(
                df, "integration_test.xlsx", ["texto_sem_erro", "texto_com_erros"]
            )
