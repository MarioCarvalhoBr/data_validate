...
class TestDataCleaning:
    ...
    def test_clean_dataframe_integers_multiple_columns(self):
        ...
        df, errors = clean_dataframe_integers(self.df, "test.csv", ["id", "value"])
    ...
    def test_clean_column_floats_with_comma_decimal(self):
        ...
        df_comma = pd.DataFrame({"value": ["1,5", "2,5", "3,0", "invalid"]})
    ...
    def test_clean_column_floats_with_nan_values(self):
        ...
        df_nan = pd.DataFrame({"value": [1.5, 2.5, np.nan, 4.5, 5.5]})
        ...
        df_test = pd.DataFrame(
            {
                ...
                "value": [
                    ...
                    "2.5",
                    "3.5",
                ],  # All valid values to avoid conversion errors
            }
        )
    ...
    def test_clean_dataframe_floats_with_invalid_values_to_cover_lines_120_123(self):
        ...
        df, errors = clean_dataframe_floats(df_test, "test.csv", ["value"])
    ...
    def test_clean_dataframe_floats_with_invalid_float_values_specific_error_messages(
        self,
    ):
        ...
        df, errors = clean_dataframe_floats(df_test, "test_file.xlsx", ["float_col"])
