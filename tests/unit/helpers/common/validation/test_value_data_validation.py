...
class TestValidateNumericValue:
    ...
    def test_validate_numeric_value_valid_cases(
        ...
        is_valid, error_msg, has_excessive_decimals = validate_numeric_value(value, row_index, column, filename)
    ...
    def test_validate_numeric_value_di_case(self) -> None:
        ...
        is_valid, error_msg, has_excessive_decimals = validate_numeric_value("DI", 5, "codigo", "dados.xlsx")
    ...
    def test_validate_numeric_value_decimal_processing_error(self) -> None:
        ...
        is_valid, error_msg, has_excessive_decimals = validate_numeric_value("invalid_text", 0, "test_col", "test.xlsx")
...
class TestProcessColumnValidation:
    ...
    def test_process_column_validation_valid_column(self, sample_dataframe: pd.DataFrame) -> None:
        ...
        errors, excessive_decimal_rows = process_column_validation(sample_dataframe, "valid_col", "test.xlsx")
    ...
    def test_process_column_validation_invalid_column(self, sample_dataframe: pd.DataFrame) -> None:
        ...
        errors, excessive_decimal_rows = process_column_validation(sample_dataframe, "invalid_col", "test.xlsx")
    ...
    def test_process_column_validation_excessive_decimals(self, sample_dataframe: pd.DataFrame) -> None:
        ...
        errors, excessive_decimal_rows = process_column_validation(sample_dataframe, "excessive_decimals", "test.xlsx")
    ...
    def test_process_column_validation_single_invalid_value(self) -> None:
        ...
        errors, excessive_decimal_rows = process_column_validation(df, "col", "test.xlsx")
...
class TestValidateDataValuesInColumns:
    ...
    def test_validate_data_values_in_columns_valid_columns(self, sample_dataframe: pd.DataFrame) -> None:
        ...
        errors, warnings = validate_data_values_in_columns(sample_dataframe, ["col1"], "test.xlsx")
    ...
    def test_validate_data_values_in_columns_excessive_decimals(self, sample_dataframe: pd.DataFrame) -> None:
        ...
        errors, warnings = validate_data_values_in_columns(sample_dataframe, ["col2"], "test.xlsx")
    ...
    def test_validate_data_values_in_columns_invalid_values(self, sample_dataframe: pd.DataFrame) -> None:
        ...
        errors, warnings = validate_data_values_in_columns(sample_dataframe, ["col3"], "test.xlsx")
    ...
    def test_validate_data_values_in_columns_all_invalid(self, sample_dataframe: pd.DataFrame) -> None:
        ...
        errors, warnings = validate_data_values_in_columns(sample_dataframe, ["col4"], "test.xlsx")
    ...
    def test_validate_data_values_in_columns_multiple_columns(self, sample_dataframe: pd.DataFrame) -> None:
        ...
        errors, warnings = validate_data_values_in_columns(sample_dataframe, ["col1", "col2", "col3"], "test.xlsx")
    ...
    def test_validate_data_values_in_columns_empty_columns_list(self, sample_dataframe: pd.DataFrame) -> None:
        ...
        errors, warnings = validate_data_values_in_columns(sample_dataframe, [], "test.xlsx")
    ...
    def test_validate_data_values_in_columns_nonexistent_column(self, sample_dataframe: pd.DataFrame) -> None:
        ...
        with pytest.raises(KeyError):
            validate_data_values_in_columns(sample_dataframe, ["nonexistent_col"], "test.xlsx")
...
class TestEdgeCases:
    ...
    def test_very_large_numbers(self) -> None:
        ...
        large_number = 1e20
        is_valid, error_msg, has_excessive_decimals = validate_numeric_value(large_number, 0, "test_col", "test.xlsx")
    ...
    def test_very_small_numbers(self) -> None:
        ...
        small_number = 1e-10
        is_valid, error_msg, has_excessive_decimals = validate_numeric_value(small_number, 0, "test_col", "test.xlsx")
    ...
    def test_zero_variations(self) -> None:
        ...
        for zero_val in zero_values:
            is_valid, error_msg, has_excessive_decimals = validate_numeric_value(zero_val, 0, "test_col", "test.xlsx")
    ...
    def test_negative_numbers_with_decimals(self) -> None:
        ...
        is_valid, error_msg, has_excessive_decimals = validate_numeric_value(-10.555, 0, "test_col", "test.xlsx")
    ...
    def test_scientific_notation(self) -> None:
        ...
        is_valid, error_msg, has_excessive_decimals = validate_numeric_value("1.5e2", 0, "test_col", "test.xlsx")
    ...
    def test_special_float_values(self) -> None:
        ...
        is_valid, error_msg, has_excessive_decimals = validate_numeric_value(float("inf"), 0, "test_col", "test.xlsx")
