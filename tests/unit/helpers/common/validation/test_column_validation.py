...
class TestCheckColumnNames:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (['categoria', 'status', 'tipo'], ['categoria', 'status', 'tipo'], ['id', 'nome', 'valor']),
            ...
            (['id', 'nome', 'valor', 'cat1', 'cat2', 'cat3'], ['cat1', 'cat2', 'cat3'], []),
        ]
    )
    ...
    def test_check_column_names_filters_unnamed_columns(
        self,
        dataframe_with_unnamed_columns: pd.DataFrame
    ) -> None:
        ...
        missing_columns, extra_columns = check_column_names(
            dataframe_with_unnamed_columns,
            expected_columns
        )
    ...
    def test_check_column_names_case_sensitivity(
        self,
        dataframe_with_mixed_case_columns: pd.DataFrame
    ) -> None:
        ...
        # Act
        missing_columns, extra_columns = check_column_names(
            dataframe_with_mixed_case_columns,
            expected_columns
        )
    ...
    def test_check_column_names_with_numeric_column_names(self) -> None:
        ...
        expected_columns = [0, 1]  # numeric columns as integers (how pandas stores them)
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                {'temperatura': [25.5, 26.0], 'umidade': [60, 65], 'pressão': [1013, 1015]},
    ...
    def test_check_column_names_comprehensive_integration(self) -> None:
        ...
        expected_extra = ['valor (R$)', 'categoria_extra']  # Unnamed columns should be filtered
