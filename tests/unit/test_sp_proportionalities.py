...
def test_count_errors_verify_sp_scenario_punctuation_data_errors_01():
    ...
    assert warnings[2] == "proporcionalidades.xlsx, linha 4: Existe 1 valor com mais de 3 casas decimais na planilha, serão consideradas apenas as 3 primeiras casas decimais."
